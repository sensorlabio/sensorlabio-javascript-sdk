...
var toPrimitive = __webpack_require__(407);
var dP = Object.defineProperty;
...
var redefine = __webpack_require__(408);
var hide = __webpack_require__(55);
var Iterators = __webpack_require__(63);
var $iterCreate = __webpack_require__(409);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(260));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_endpoints_users__ = __webpack_require__(398);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_endpoints_users___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__src_endpoints_users__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_endpoints_auth__ = __webpack_require__(439);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_endpoints_auth___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__src_endpoints_auth__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_endpoints_profile__ = __webpack_require__(441);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_endpoints_profile___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__src_endpoints_profile__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_endpoints_sensors__ = __webpack_require__(443);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_endpoints_sensors___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__src_endpoints_sensors__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_endpoints_measurements__ = __webpack_require__(445);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_endpoints_measurements___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__src_endpoints_measurements__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_responses_api__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_responses_api___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__src_responses_api__);

let axios = __webpack_require__(379);
...
class SensorlabApi {
    ...
    constructor(rest_api_url = 'http://staging.sensorlab.io/api/v1', jwt_token = null) {
        ...
        this.users = new __WEBPACK_IMPORTED_MODULE_1__src_endpoints_users___default.a(this);
        this.auth = new __WEBPACK_IMPORTED_MODULE_2__src_endpoints_auth___default.a(this);
        this.profile = new __WEBPACK_IMPORTED_MODULE_3__src_endpoints_profile___default.a(this);
        this.sensors = new __WEBPACK_IMPORTED_MODULE_4__src_endpoints_sensors___default.a(this);
        this.measurements = new __WEBPACK_IMPORTED_MODULE_5__src_endpoints_measurements___default.a(this);
    ...
    _prepareApiResponse(response) {
        if (response.status == 200) { //normal response
            if (response.data.token) {
                return new __WEBPACK_IMPORTED_MODULE_6__src_responses_api___default.a(true, response.status, 100, null, response.data.token);
            } else if (response.data.success) {
                return new __WEBPACK_IMPORTED_MODULE_6__src_responses_api___default.a(response.data.success, response.status, response.data.code, response.data.message);
            } else {
                return new __WEBPACK_IMPORTED_MODULE_6__src_responses_api___default.a(response.data.success, response.status, response.data.code, response.data.message);
            }
        } else if (response.status == 401) { //401 Unauthorized error
            throw new __WEBPACK_IMPORTED_MODULE_6__src_responses_api___default.a(false, response.status, 0, response.data);
        } else {
            let message = null;
            if ('message' in response.data) {
                message = response.data.message;
            }
            throw new __WEBPACK_IMPORTED_MODULE_6__src_responses_api___default.a(false, response.status, 0, message);
        }
    }
}
...
var UsersEndpoint = function () {
    ...
    function UsersEndpoint(api) {
        (0, _classCallCheck3.default)(this, UsersEndpoint);
    ...
    (0, _createClass3.default)(UsersEndpoint, [{
        key: 'signup',
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(email, password, password_check) {
                var data, response;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
        ...
        key: 'verify_email',
        value: function () {
            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(verification_token) {
                var data, response;
        ...
        value: function () {
            var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(token) {
                var data, response;
        ...
        key: 'reset_password',
        value: function () {
            var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(token, password, password_check) {
                var data, response;
...
module.exports = !__webpack_require__(56) && !__webpack_require__(162)(function () {
...
var dP = __webpack_require__(61);
var anObject = __webpack_require__(50);
var getKeys = __webpack_require__(412);
...
var ProfileEndpoint = function () {
    ...
    function ProfileEndpoint(api) {
        (0, _classCallCheck3.default)(this, ProfileEndpoint);
    ...
    (0, _createClass3.default)(ProfileEndpoint, [{
        key: 'get',
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                var response, result;
        ...
        key: 'change_password',
        value: function () {
            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(old_password, new_password, new_password_check) {
                var data, response;
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
...
var Profile = function () {
    ...
    (0, _createClass3.default)(Profile, [{
        key: "change_password",
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(old_password, new_password, new_password_check) {
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
...
var _sensors = __webpack_require__(444);

var _sensors2 = _interopRequireDefault(_sensors);

var _sensor = __webpack_require__(174);
...
var SensorsEndpoint = function () {
    ...
    function SensorsEndpoint(api) {
        (0, _classCallCheck3.default)(this, SensorsEndpoint);
    ...
    (0, _createClass3.default)(SensorsEndpoint, [{
        key: 'list',
        value: function () {
        ...
        key: 'one',
        value: function () {
            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(sensor_id) {
                var response;
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
...
var SensorsResponse = function SensorsResponse(api, data) {
    (0, _classCallCheck3.default)(this, SensorsResponse);
...
var _measurements = __webpack_require__(446);

var _measurements2 = _interopRequireDefault(_measurements);

var _measurement = __webpack_require__(175);
...
var MeasurementsResponse = function MeasurementsResponse(api, data) {
    (0, _classCallCheck3.default)(this, MeasurementsResponse);
